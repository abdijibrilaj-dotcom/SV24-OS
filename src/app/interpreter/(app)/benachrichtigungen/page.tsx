...
export default async function InterpreterBenachrichtigungenPage() {
  ...
  return (
    <MobileScreen header={{ mode: "back", title: "Benachrichtigungen", backHref: "/interpreter" }} tabBar={undefined}>
      {notifications.map((n) => (
